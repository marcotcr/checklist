...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, "checklist", 'viewer', 'static', 'extension.js'),
        os.path.join(here, "checklist", 'viewer', 'static', 'index.js')
    ]
...
setup(name='checklist',
      ...
      data_files=[
        ('share/jupyter/nbextensions/viewer', [
            'viewer/static/extension.js',
            'viewer/static/index.js',
            'viewer/static/index.js.map',
        ],),
        ('etc/jupyter/nbconfig/notebook.d' ,['viewer.json'])
      ],
      cmdclass={
